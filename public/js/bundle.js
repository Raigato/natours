...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoicmFpZ2F0byIsImEiOiJja3M5M3Y4cnQxZ3FkMzFzM25haWEwNnpvIn0.lz9pZxV0uNt8tfy0g173ww";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "data" ? "/api/v1/users/update-user" : "/api/v1/users/update-password";
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: url,
...
var stripe = Stripe("pk_test_BffBAlozAfz3eBkViSORIUfv");
...
var userUpdateForm = document.querySelector(".form-user-data");
